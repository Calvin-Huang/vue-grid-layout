...
// CONCATENATED MODULE: ./src/components/GridLayout.vue?vue&type=template&id=0b75ae14&
...
/* harmony default export */ var GridLayoutvue_type_script_lang_js_ = ({
  ...
  watch: {
    ...
    layout: lodash_debounce_default()(function () {
      this.layoutUpdate();
    }, 50),
  ...
  methods: {
    ...
    dragEvent: function dragEvent(eventName, id, x, y, h, w) {
      ...
      this.layout = Object(utils["g" /* moveElement */])(this.layout, l, x, y, true, this.preventCollision, this.responsiveColNum === null ? this.colNum : this.responsiveColNum);
    ...
    responsiveGridLayout: function responsiveGridLayout() {
      ...
      this.responsiveColNum = newCols; // save actual layout in layouts
...
var LIBRARY = __webpack_require__("2d00");
var wksExt = __webpack_require__("37c83");
...
/* harmony import */ var core_js_modules_es6_object_keys__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__("456d");
...
/* harmony import */ var core_js_modules_es6_array_sort__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__("55dd");
...
/*: Layout*/
{
  ...
  var oldX = l.x;
  var oldY = l.y;
  var oldIndex = oldY * colNum + oldX;
  var targetIndex = y * colNum + x;
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      var _i = item.y * colNum + item.x;

      if (targetIndex > oldIndex) {
        if (_i > oldIndex && _i <= targetIndex) {
          var newI = _i - 1;
          item.x = newI % colNum;
          item.y = Math.floor(newI / colNum);
        }
      } else {
        if (_i >= targetIndex && _i < oldIndex) {
          var _newI = _i + 1;

          item.x = _newI % colNum;
          item.y = Math.floor(_newI / colNum);
        }
      }
    }
  } catch (err) {
